...
function changecsstopath(path){
    replacejscssfilebypath(path,'/resource/style.css','css');
    replacejscssfilebypath(path,'/resource/ebankstyle.css','css');
}
...
function changeJSandCSStoMB() {
	replacejscssfile('resource/css/style.css', 'resource/cssmb/style.css', 'css');
	replacejscssfile('resource/css/ebankstyle.css', 'resource/cssmb/ebankstyle.css', 'css');
	//replacejscssfile('css/fonts.css', 'cssmb/fonts.css', 'css');
}

function changeJSandCSStoIB() {
	replacejscssfile('resource/cssmb/style.css', 'resource/css/style.css', 'css');
	replacejscssfile('resource/cssmb/ebankstyle.css', 'resource/css/ebankstyle.css', 'css');
	//replacejscssfile('cssmb/fonts.css', 'css/fonts.css', 'css');
}
function changeJSandCSSLighttoIB() {
	replacejscssfile('resource/cssmb-light/style.css', 'resource/css/style.css', 'css');
	replacejscssfile('resource/cssmb-light/ebankstyle.css', 'resource/css/ebankstyle.css', 'css');
	//replacejscssfile('cssmb/fonts.css', 'css/fonts.css', 'css');
}
function changeJSandCSStoMBLight() {
	replacejscssfile('resource/css/style.css', 'resource/cssmb-light/style.css', 'css');
	replacejscssfile('resource/css/ebankstyle.css', 'resource/cssmb-light/ebankstyle.css', 'css');
	//replacejscssfile('css/fonts.css', 'cssmb/fonts.css', 'css');
}
//disable right-click
function clickIE(e) {
