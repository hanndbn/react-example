...
function PieChart(opt_opts) {
    ...
    this.idAnimations = 0;
    this.colortitleSelected = opt_opts.colortitleSelected ||'#424242';
}
    ...
    if (idParrent) {
        ...
        if (parent) {
            ...
            if (this.totalItems < 3) {
                ...
                itemChart.countTick = 0;
                itemChart.countTickSecond = 0;
                itemChart.colortitleSelected = this.colortitleSelected;
                this.circleItems.push(itemChart);
...
PieChart.prototype.drawItem = function (canvas, item) {
   ...
   /* context.save();
    ...
    context.fillStyle = item.colortitleSelected;
