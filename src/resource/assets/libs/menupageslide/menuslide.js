var MenuSlide = function (params) {
    ...
    menu.initHeader = function () {
        ...
        for (var i = 0; i < numberPage; i++) {
            logInfo("menuContent1" + menuContent,"menuslide:56");
        ...
        logInfo(" menuContent  2 " + menuContent,"menuslide:79");
    ...
    menu.initFooter = function () {
      ...
      menu.contentHTML = function(){
          if(menu.footerContent.length > 0 && menu.headerContent.length>0){
               return menu.initHeader()   + "<div id='menuslide_divider'></div>" +  menu.initFooter();
          }else{
               return menu.initHeader()   + "<div id='menuslide_divider' class='divider-bottom-slide-none'></div>" +  menu.initFooter();
          }
