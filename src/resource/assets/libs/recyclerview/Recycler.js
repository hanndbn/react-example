        ...
        if (arrContent != undefined && arrContent.length > 0) {
            if(CONST_DESKTOP_MODE && !checkScreenisMobilePX()){
                if(params.type==DESKTOP_TYPE_GRID){
                    content = "<div  id ='recycler_list' class='recycler-list'><table style='width: 100%' id='recycler_table_ebank' class='recycler-table-ebank'>";
                }else{
               content = "<div align='center' id ='recycler_list' class='recycler-list'><table style='width: 100%' id='recycler_table_ebank' class='recycler-table-ebank'>";
                }
