...
var homePage = ['homepagexsl/homepage-dynamic-scr', 'homepagexsl/home-page-recent', 'homepagexsl/cus-prop-info-scr', 'homepagexsl/home-page-manage-finance'];
var bottomBarText = ['visa/card-lock','visa/card-unlock'];
var bottomBarArray = {};
var bottomBarArrayStatus = {};
var currentBottombar;

var htmlPages = ['cardservicexsl/card-advance-register', 'cardservicexsl/card-advance-return', 'bankinfo/atm-info',
    'bankinfo/bank-info-main-scr', 'bankinfo/bank-info-other-atm-area', 'bankinfo/bank-info-other-atm-city', 'bankinfo/bank-info-other-atm-list',
    'bankinfo/bank-info-tpb-atm-map', 'bankinfo/bank-info-tpb-atm', 'bankinfo/bank-info-tpb-branch-city', 'bankinfo/bank-info-tpb-branch-list',
    'bankinfo/bank-info-tpb-branch', 'bankinfo/branch-info', 'bankinfo/exchange-rate', 'bankinfo/interest-rate',
    'benefic-manage/benefic-manage-create-scr', 'egold/gold-authentication-scr-hasterm', 'egold/gold-authentication-scr',
    'egold/gold-trans-select-date-rate-scr', 'egold/gold-trans-select-date-scr', 'esaving/esaving-open-scr',
    'loan/loan-active-authen-overdraft', 'loan/loan-active-standby-overdraft', 'loan/loan-adjust-standby-overdraft', 'loan/loan-adjust-term-confirm-scr',
    'loan/loan-info-detail', 'loan/loan-info-sb-od-detail', 'loan/loan-info-sb-od', 'loan/loan-main-scr', 'loan/loan-open-standby-overdraft',
    'loan/loan-open-term-confirm-scr', 'loan/loan-overdraft-info-detail', 'loan/loan-question-advisory-scr', 'loan/loan-repayment-schedule',
    'payment/payment-adsl-create-scr', 'payment/payment-adsl-review-scr', 'payment/payment-evnhcm-accinput-scr', 'payment/payment-evnhcm-bill-review-scr',
    'payment/payment-evnhcm-bill-scr', 'payment/payment-evnhcm-create-scr', 'payment/payment-evnhcm-search-result-scr', 'payment/payment-evnhcm-search-scr',
    'payment/payment-homephone-create-scr', 'payment/payment-homephone-review-scr', 'payment/payment-mobile-create-scr', 'payment/payment-mobile-review-scr',
    'payment/payment-topup-create-scr', 'payment/payment-topup-review-scr', 'transfer/trans-input-all-bank', 'transfer/trans-input-all-branch', 'transfer/trans-input-bank',
    'transfer/trans-input-branch', 'transfer/trans-input-city', 'transfer/trans-input-sml-bankcode', 'transfer/transfer-inter-create-scr',
    'transfer/transfer-local-cusno-create-scr', 'transfer/transfer-periodic-interbank-create-scr', 'utilitiesxsl/utilities-disconnect-momo',
    'utilitiesxsl/utilities-map-momo'
];
...
function ref(width,height){
    var bottomBar = new BottomBar({
        ...
        backgroundColorSelected: '#ff8c29',
        lineHeightNormal: 1,
        lineColorNormal: '#a177a9',
        totalItem: 4,
        ...
        selectIndex: function (indexTabar) {
            if (indexTabar == 0) {
                ...
                navController.initWithRootView('homepagexsl/home-page-recent', true, 'xsl');
            }
            else if (indexTabar == 2) {
                getCusFinInfo();
            }
            else if (indexTabar == 3) {
                navController.initWithRootView('homepagexsl/home-page-manage-finance', true, 'xsl');
            }
           
            logInfo(indexTabar,"bottombar:285");
        }
    });
...
////        if(navArrayScr[navArrayScr.length - 1] == 'homepagexsl/homepage-dynamic-scr') {
        ...
        var bottomBar = new BottomBar({
            ...
            selectIndex: function (indexTabar) {
                if (indexTabar == 0) {
                 ...
                 logInfo(indexTabar,"bottombar:349");
            }
        });
...
function initBottomBarShortCut(pageView, arrBottom, inID, isCallBack,callBack,allowActive) {
    ...
    if (!tabbarHome) {
        ...
        var bottomBar = new BottomBar({
            ...
            selectIndex: function (indexTabar) {
                //console.log('khanhduy.le : ' + indexTabar);
                 logInfo(indexTabar,"bottombar:476");
            }
        });
...
//        }
        ...
        if(arrBottom.length>0){
            ...
            var noteBottomParrent = document.getElementById("navBottomBar");
            var noteBottomChild = document.getElementById("bottomBarShortCut" + inID);
            if(noteBottomParrent!=undefined && noteBottomChild!=undefined){
                 noteBottomParrent.removeChild(noteBottomChild);
            }
            //anhntt comment
            if(gModeScreenView == CONST_MODE_SCR_SMALL){
                tabbarHome.style.bottom =   '-47px';
            ...
            var bottomBar = new BottomBar({
                ...
                selectIndex: function (indexTabar) {
                 ...
                 logInfo(indexTabar,"bottombar:515");
                }
            });
    //        if(pageView != "menuxsl/dynamic-menu-scr"){
                bottomBar.showBottomBarShortCut(tabbarHome, inID,isCallBack,callBack,allowActive);
...
BottomBar.prototype.showBottomBarTextWithElement = function (parent, inID) {
    ...
    for (i = 0; i < this.totalItem; i++) {
        ...
        item.addEventListener('click', function (e) {
            ...
            if(document.getElementById('myModalDialog')){
                document.getElementById('myModalDialog').style.display = "none";
            }
        }, false);
    }
}
...
BottomBar.prototype.showBottomBarShortCut = function (parent, inID,isCallBack,callBack,allowActive) {
    ...
    for (i = 0; i < this.totalItem; i++) {
        ...
        if(gModeScreenView == CONST_MODE_SCR_MEDIUM){
            div.style.width = ((mainview-152) / this.totalItem) + "px";
            div.style.position= 'absolute';
            if(this.totalItem == 4){
                div.style.marginLeft= '-27%';
            }else if(this.totalItem == 3){
