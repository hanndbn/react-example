...
var arrayColor = ['#F44336', '#6a1b9a', '#4CAF50', '#2196F3', '#3f48cc'];
var arrayIconColor = ['#fff', '#fff', '#fff', '#fff', '#fff'];  //anhntt cmt mau icon
...
var arrayTexts = ["Tài khoản", "Chuyển tiền trong TPbank", "Nạp tiền", "Gửi tiết kiệm điện tử"];
var file='xsl';
...
function showMenuLeft(menu, screenWidth, screenHeight, totalItems, radius, menusize) {
    ...
    if (screenHeight - centerMenu.y < radius) {
        ...
        for (var i = 0; i < totalItems; i++) {
            ...
            floatingText.style.paddingRight = '2px';
    ...
    var icon1 = document.getElementById("floatingButtonIcon1")
    icon1.style.position ='absolute';
    icon1.style.left='8px';
