...
//anhntt refresh actionbar
    ...
    initActionBarAddBackStack: function (curPage) {
        ...
        logInfo(curPage + ":" + curPage,"actionbar:57");
    ...
    initActionBarAddPopAll: function (curPage) {
        ...
        this.showNavHeaderBar();
        this.setHavingBackground(true);
        if(curPage == 'homepagexsl/homepage-dynamic-scr' && gModeScreenView == CONST_MODE_SCR_MEDIUM){
    ...
    showStepSequence : function(curPage){
        ...
        if(flagCheck == true){
            ...
            for(var i=0; i<3 ; i++){
                ...
                iStep.style.color = i == (indexSequence-1) ? "#ff8c29": "#FFF";
//                    iStep.style.color = "rgb(230, 135, 29)";
       ...
       if(gModeScreenView == CONST_MODE_SCR_SMALL){
           ...
           if (gift) {
               ...
               if (gUserInfo.userAvatar) {
                   ...
                   document.getElementById('nav.btn.right2').innerHTML = '<span onclick="onpenNotification();"  class="icon-notification ripple-add-on" style="font-size:20px;border-radius: 100%;background: #561f45;padding: 5px;"/>';
                   document.getElementById('nav.btn.right2').style.marginRight = '6px';
    ...
    cacheTitle: function (page) {
        if (currentTitle != null || currentTitle != '') {
            ...
            currentPage = page;
             logInfo( page + ":" + currentTitle,"actionbar:389");
            //hien thi Sequence
            this.showStepSequence(currentPage);
        }
    }
...
//            pageHeader.style.top = (-document.getElementById("tabHost").offsetHeight +25)+"px";
        ...
        if(ePage == 'homepagexsl/homepage-dynamic-scr' && gModeScreenView == CONST_MODE_SCR_MEDIUM){
            var barTitle = document.getElementById('nav.titleBar');
            if(barTitle){
                barTitle.style.top = '0px';
                //daitq cmt
...
function resumeView() {
    ...
    if (countView > 1) {
       ...
       if(gModeScreenView == CONST_MODE_SCR_SMALL){
        ...
        {
             iconHome.style.transition = 'all 0.3s ease-in-out';
            setTimeout(function () {
                 iconHome.style.display = 'block';
            },300);
