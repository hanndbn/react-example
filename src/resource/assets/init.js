...
function loaded() {
    ...
    /*if(CONST_DESKTOP_MODE) {
		(function() {
			...
			script.src = './resource/assets/libs/jquery.js';
    ...
    loadjscssfile('./resource/assets/libs/calendar/datepicker.css', 'css');
    loadjscssfile('./resource/assets/libs/calendar/datepicker.js', 'js');
    loadjscssfile('./resource/assets/libs/slip.js', 'js');

//     setTimeout(function () {
//         loadjscssfile(CONST_WEB_URL_LINK + 'resource/assets/system-payment-config.js', 'js');
//         loadjscssfile(CONST_WEB_URL_LINK + 'resource/assets/sysdata/paymentComboFields.js', 'js');
//         loadjscssfile(CONST_WEB_URL_LINK + 'resource/assets/sysdata/paymentGroups.js', 'js');
//         loadjscssfile(CONST_WEB_URL_LINK + 'resource/assets/sysdata/paymentProviders.js', 'js');
//         loadjscssfile(CONST_WEB_URL_LINK + 'resource/assets/sysdata/paymentRequestFields.js', 'js');
//         loadjscssfile(CONST_WEB_URL_LINK + 'resource/assets/sysdata/paymentServices.js', 'js');
//         setTimeout(function () {
//             loadjscssfile(CONST_WEB_URL_LINK + 'resource/assets/sysdata/branchInterbanks.js', 'js');
//             loadjscssfile(CONST_WEB_URL_LINK + 'resource/assets/sysdata/branchs.js', 'js');
//             loadjscssfile(CONST_WEB_URL_LINK + 'resource/assets/sysdata/countries.js', 'js');
//             loadjscssfile(CONST_WEB_URL_LINK + 'resource/assets/sysdata/districts.js', 'js');
//             loadjscssfile(CONST_WEB_URL_LINK + 'resource/assets/sysdata/interbanks.js', 'js');
//             loadjscssfile(CONST_WEB_URL_LINK + 'resource/assets/sysdata/provinces.js', 'js');
//             loadjscssfile(CONST_WEB_URL_LINK + 'resource/assets/system-data.js', 'js');
//         }, 1000);
// //        reloadTopBanner();
//     }, 1000);
...
//var getMBOperatingSystem = getMobileOperatingSystem();
//var Version = parseInt(getAndroidVersion());
//console.log("anhtt MobileOperatingSystem: "+getMBOperatingSystem+" Version: "+Version);
...
if(is_firefox) {
	replacejscssfile('./resource/assets/mb-service.js', './other/mb-service.js', 'js');
	replacejscssfile('./resource/assets/common.js', './other/common.js', 'js');
}*/
